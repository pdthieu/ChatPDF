...
[Link to Website](https://www.youtube.com/watch?v=bZFedu-0emE)
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/pdthieu/chatpdf.git
   ```
...
5. **Setup environment variables**
   ...
   Copy `.env.example` to `.env.local` file in the root directory of your project and add the required environment variables.
